...
Write-Host ""
Write-Host "1. Test Bybit connection:"
Write-Host "   docker compose exec trading_bot python scripts/test_connection_docker.py"
Write-Host ""
Write-Host "2. View Dashboard:"
Write-Host "   docker compose --profile monitoring up -d dashboard"
Write-Host "   Open: http://localhost:8501"
Write-Host ""
Write-Host "3. Download historical data (for backtesting):"
Write-Host "   docker compose exec trading_bot python scripts/download_historical_data.py"
Write-Host ""
Write-Host "4. Run tests:"
Write-Host "   docker compose exec trading_bot pytest tests/unit/ -v"
Write-Host ""
Write-Host "5. View logs:"
Write-Host "   docker compose logs -f trading_bot"
Write-Host ""
